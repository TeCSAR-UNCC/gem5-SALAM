...
def buildlenet5(options, system, clstr):
	...
	clstr.conv0cache = L1Cache(size = '2048B')
	clstr.conv0cache.mem_side = clstr.coherency_bus.slave
	clstr.conv0cache.cpu_side = clstr.conv0.local
	...
	clstr.conv1cache = L1Cache(size = '2048B')
	clstr.conv1cache.mem_side = clstr.coherency_bus.slave
	clstr.conv1cache.cpu_side = clstr.conv1.local
	...
	clstr.fc0cache = L1Cache(size = '2048B')
	clstr.fc0cache.mem_side = clstr.coherency_bus.slave
	clstr.fc0cache.cpu_side = clstr.fc0.local
	...
	clstr.fc1cache = L1Cache(size = '2048B')
	clstr.fc1cache.mem_side = clstr.coherency_bus.slave
	clstr.fc1cache.cpu_side = clstr.fc1.local
