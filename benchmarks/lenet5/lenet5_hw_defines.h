...
#define conv0WeightSize conv0KSize*conv0KSize*conv0KernChan*sizeof(TYPE)
...
#define conv1WeightSize conv1KSize*conv1KSize*conv1KernChan*sizeof(TYPE)
...
#define fc0WeightSize fc0KSize*fc0KSize*fc0KernChan*sizeof(TYPE)
...
#define fc1WeightSize fc1KSize*fc1KSize*fc1KernChan*sizeof(TYPE)
...
#define Conv1Output 0x1002d07d
#define Conv1LUT 0x1002e97d
//Accelerator: POOL1
#define POOL1 0x1002e981
#define pool1Input 0x1002e982
#define pool1Output 0x10030282
//Accelerator: FC0
#define FC0 0x100308c2
#define fc0Input 0x100308c3
#define fc0Weights 0x10030f03
#define fc0Output 0x10033de3
#define fc0LUT 0x10033fc3
//Accelerator: FC1
#define FC1 0x10033fc7
#define fc1Input 0x10033fc8
#define fc1Weights 0x100341a8
#define fc1Output 0x100342f8
#define fc1LUT 0x10034448
//END GENERATED CODE