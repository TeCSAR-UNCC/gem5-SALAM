...
; <label>:8                                       ; preds = %6
  %9 = load volatile i8, i8* inttoptr (i64 788762346 to i8*), align 2
  %10 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv
  store volatile i8 %9, i8* %10, align 1
  br label %13

; <label>:11                                      ; preds = %6
  %12 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv
...
.preheader:                                       ; preds = %.preheader.preheader, %34
  ...
  %15 = getelementptr inbounds i8, i8* inttoptr (i64 788935147 to i8*), i64 %indvars.iv25
  %16 = load volatile i8, i8* %15, align 1
  %17 = getelementptr inbounds i8, i8* inttoptr (i64 788936347 to i8*), i64 %indvars.iv25
  %18 = load volatile i8, i8* %17, align 1
  %19 = mul nuw nsw i64 %indvars.iv25, 720
  br label %20

; <label>:20                                      ; preds = %20, %.preheader
  %indvars.iv18 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next19, %20 ]
  %sum.17 = phi i32 [ 0, %.preheader ], [ %33, %20 ]
  %21 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv18
  %22 = load volatile i8, i8* %21, align 1
  %23 = add i64 %indvars.iv18, %19
  %sext30 = shl i64 %23, 32
  %24 = ashr exact i64 %sext30, 32
  %25 = getelementptr inbounds i8, i8* inttoptr (i64 788762347 to i8*), i64 %24
  ...
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 720
...
; <label>:34                                      ; preds = %20
  ...
  %37 = getelementptr inbounds i8, i8* inttoptr (i64 788935387 to i8*), i64 %indvars.iv25
  %38 = load volatile i8, i8* %37, align 1
  %39 = zext i8 %38 to i32
  %40 = getelementptr inbounds i8, i8* inttoptr (i64 788935627 to i8*), i64 %indvars.iv25
  ...
  %51 = getelementptr inbounds i8, i8* inttoptr (i64 788935867 to i8*), i64 %indvars.iv25
  %52 = load volatile i8, i8* %51, align 1
  %53 = zext i8 %52 to i32
  %54 = mul nsw i32 %50, %53
  %55 = getelementptr inbounds i8, i8* inttoptr (i64 788936107 to i8*), i64 %indvars.iv25
  ...
  store volatile i8 %63, i8* inttoptr (i64 788537449 to i8*), align 1
...
; <label>:66                                      ; preds = %13
  %67 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv.next
  store volatile i8 %input_zp, i8* %67, align 1
  br label %71

; <label>:68                                      ; preds = %13
  %69 = load volatile i8, i8* inttoptr (i64 788762346 to i8*), align 2
  %70 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv.next
...
; <label>:73                                      ; preds = %71
  %74 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv.next.1
  store volatile i8 %input_zp, i8* %74, align 1
  br label %78

; <label>:75                                      ; preds = %71
  %76 = load volatile i8, i8* inttoptr (i64 788762346 to i8*), align 2
  %77 = getelementptr inbounds i8, i8* inttoptr (i64 788936587 to i8*), i64 %indvars.iv.next.1
  store volatile i8 %76, i8* %77, align 1
  br label %78

; <label>:78                                      ; preds = %75, %73
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %exitcond.2 = icmp eq i64 %indvars.iv.next.2, 720
