...
#    mem_side0 = MasterPort("Memory side port, sends requests")
#    mem_side1 = MasterPort("Memory side port, sends requests")
#    mem_side2 = MasterPort("Memory side port, sends requests")
#    mem_side3 = MasterPort("Memory side port, sends requests")
    ...
    dram_ranges = VectorParam.AddrRange("Address Ranges of DRAM")
