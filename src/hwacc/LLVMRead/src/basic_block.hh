...
namespace SALAM {
  class BasicBlock {
    ...
    public:
      ...
      BasicBlock(llvm::BasicBlock * bb, RegisterList *regs, bool dbg=false);
      ~BasicBlock();
      ...
      void setDebug(bool);
      std::vector<std::shared_ptr<InstructionBase> > * Nodes() { return &_Nodes; }
      std::string Name() { return _Name; }
      llvm::BasicBlock * getIRValue() { return irvalue; }
      void dump();
  };
}
