...
class FunctionalUnits(SimObject):
	...
	float_trig_sine = Param.FloatTrigSine(Parent.any, "float_trig_sine functional unit SimObject.")
...
class DoubleMultiplier(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from double_multiplier.yml")
...
class BitRegister(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from bit_register.yml")
...
class BitwiseOperations(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from bitwise_operations.yml")
...
class DoubleAdder(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from double_adder.yml")
...
class FloatDivider(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from float_divider.yml")
...
class BitShifter(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from bit_shifter.yml")
...
class IntegerMultiplier(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from integer_multiplier.yml")
...
class IntegerAdder(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from integer_adder.yml")
...
class DoubleDivider(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from double_divider.yml")
...
class FloatAdder(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from float_adder.yml")
...
class FloatMultiplier(SimObject):
	...
	fu_latency = Param.String("5", "Default values set from float_multiplier.yml")
...
class FloatTrigSine(SimObject):
	# SimObject type
	type = 'FloatTrigSine'
	# gem5-SALAM attached header
	cxx_header = "src/hwacc/HWModeling/generated/functionalunits/float_trig_sine.hh"
	#HW Params
	alias = Param.String("float_trig_sine", "Default values set from float_trig_sine.yml")
	stages = Param.UInt32(3, "Default values set from float_trig_sine.yml")
	cycles = Param.UInt32(3, "Default values set from float_trig_sine.yml")
	enum_value = Param.UInt32(17, "Default values set from float_trig_sine.yml")
	int_size = Param.String("none", "Default values set from float_trig_sine.yml")
	int_sign = Param.String("none", "Default values set from float_trig_sine.yml")
	int_apmode = Param.Bool(False, "Default values set from float_trig_sine.yml")
	fp_size = Param.String("single", "Default values set from float_trig_sine.yml")
	fp_sign = Param.String("any", "Default values set from float_trig_sine.yml")
	fp_apmode = Param.Bool(True, "Default values set from float_trig_sine.yml")
	ptr_size = Param.String("none", "Default values set from float_trig_sine.yml")
	ptr_sign = Param.String("none", "Default values set from float_trig_sine.yml")
	ptr_apmode = Param.Bool(False, "Default values set from float_trig_sine.yml")
	limit = Param.UInt32(0, "Default values set from float_trig_sine.yml")
	#Power Params
	power_units = Param.String("mW", "Default values set from float_trig_sine.yml")
	energy_units = Param.String("pJ", "Default values set from float_trig_sine.yml")
	time_units = Param.String("ns", "Default values set from float_trig_sine.yml")
	area_units = Param.String("um^2", "Default values set from float_trig_sine.yml")
	fu_latency = Param.String("5", "Default values set from float_trig_sine.yml")
	internal_power = Param.UInt32(0.009743773, "Default values set from float_trig_sine.yml")
	switch_power = Param.UInt32(0.007400587, "Default values set from float_trig_sine.yml")
	dynamic_power = Param.UInt32(0.001800732, "Default values set from float_trig_sine.yml")
	dynamic_energy = Param.UInt32(0.009003937, "Default values set from float_trig_sine.yml")
	leakage_power = Param.UInt32(7.395312e-05, "Default values set from float_trig_sine.yml")
	area = Param.UInt32(5.981433, "Default values set from float_trig_sine.yml")
	path_delay = Param.UInt32(1.75, "Default values set from float_trig_sine.yml")
